...
export const discoverUnpaired = () => dispatch => {
...
export const cancelDiscovery = () => dispatch => {
...
export const sec0 = () => dispatch => {
  dispatch(Section0())
}

export const sec1 = () => dispatch => {
  dispatch(Section1())
}

export const discovertrue = () => dispatch => {
  dispatch(discoveringTrue())
}

export const discoverfalse = () => dispatch => {
  dispatch(discoveringfalse())
}
