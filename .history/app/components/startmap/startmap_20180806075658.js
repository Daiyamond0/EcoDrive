...
var numbers = this.state.distance;
  ...
  this.setState({co2:[...this.state.co2,100/(this.state.sum.toFixed(1) / this.state.totalfueluse[totalfueluse.length - 1])]})
};
...
getDistance(){
  ...
  render() {
    ...
    return (
      ...
      <View style={{}}>
        <Text>StartMap</Text>
        <Text>{JSON.stringify(this.props.text.FuelConsumption)}</Text>
        <ScrollView>
            {/* <Text>5555</Text> */}
            {/* {this.getDistance()} */}
            ...
            <Text>{this.state.co2[this.state.co2.length - 1]}</Text>
            </ScrollView>
            </View>
            <View style={{
