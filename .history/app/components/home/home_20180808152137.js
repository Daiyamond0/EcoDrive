        ...
        flex:1}}>
            ...
            <View>
              <ActivityIndicator animating={this.state.visible}/>
               <Text> {
                  this.state.cardetail.Make === undefined && this.state.cardetail.Model === undefined ? 
                  ' ':
                  this.state.cardetail.Make+' '+this.state.cardetail.Model+this.setState({visible:false})
                  }</Text>
            </View>
        </View>
        <Footer>
